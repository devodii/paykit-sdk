...
export const PROVIDERS: Provider[] = [
  ...
  },
  {
    id: 'mercadopago',
    name: 'MercadoPago',
    tagline: 'Payment processing for Latin America',
    region: 'Latin America',
    packageName: '@paykit-sdk/mercadopago',
    initFn: 'mercadopago',
    website: 'https://mercadopago.com',
    docsUrl: 'https://docs.usepaykit.dev/providers/mercadopago',
    logo: 'https://8rcejvvfub.ufs.sh/f/PUZcIXo3ao8I2ssF9HpMT1Qe0u47ztHslnAxZFBochVJLGbU',
  },
  {
    id: 'xendit',
    name: 'Xendit',
    tagline: 'Payment infrastructure for Southeast Asia',
    region: 'Southeast Asia',
    packageName: '@paykit-sdk/xendit',
    initFn: 'xendit',
    website: 'https://xendit.co',
    docsUrl: 'https://docs.usepaykit.dev/providers/xendit',
    logo: 'https://8rcejvvfub.ufs.sh/f/PUZcIXo3ao8I9my3dXPVKgb71SJn80lRIkmyqieMZrXaT5oF',
  },
  {
    id: 'chapa',
    name: 'Chapa',
  ...
  },
  {
    ...
    region: 'India',
    packageName: '@paykit-sdk/razorpay',
    initFn: 'razorpay',
    website: 'https://razorpay.com',
    docsUrl: 'https://docs.usepaykit.dev/providers/razorpay',
    logo: 'https://8rcejvvfub.ufs.sh/f/PUZcIXo3ao8INMT2nXV6UrDfHdZvpJ0IcF7AYtosjnl6CaO5',
  },
  {
    id: 'moneygram',
    name: 'MoneyGram',
